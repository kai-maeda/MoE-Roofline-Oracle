An analytical inference performance oracle for MoE LLMs. Sweeps TP/EP/PP parallelism configurations to find the Pareto-optimal GPU across ITL, TTFT, and cost per million tokens.
